...
1. **Clone the repository**
   ```bash
   git clone https://github.com/RajanBam/Rajan_Bam_Software-Development-Skills-Mobile-2025-26-Android-mobile-development.git
   cd AndriodMobileAPP
   ```
...
**Built with dedication for learning Android development**
